                          ...
                          _Unwind_FrameState *fs)
{
	...
	/* We expect context->cfa and context->ra to be equal */
	if (context->cfa != context->ra)
		return _URC_END_OF_STACK;
	...
	fs->regs.reg[0].loc.offset = (long) &sc->sc_regs.r00 - new_cfa;
	fs->regs.reg[1].how = REG_SAVED_OFFSET;
	fs->regs.reg[1].loc.offset = (long) &sc->sc_regs.r01 - new_cfa;
	fs->regs.reg[2].how = REG_SAVED_OFFSET;
	fs->regs.reg[2].loc.offset = (long) &sc->sc_regs.r02 - new_cfa;
	fs->regs.reg[3].how = REG_SAVED_OFFSET;
	fs->regs.reg[3].loc.offset = (long) &sc->sc_regs.r03 - new_cfa;
	fs->regs.reg[4].how = REG_SAVED_OFFSET;
	fs->regs.reg[4].loc.offset = (long) &sc->sc_regs.r04 - new_cfa;
	fs->regs.reg[5].how = REG_SAVED_OFFSET;
	fs->regs.reg[5].loc.offset = (long) &sc->sc_regs.r05 - new_cfa;
	fs->regs.reg[6].how = REG_SAVED_OFFSET;
	fs->regs.reg[6].loc.offset = (long) &sc->sc_regs.r06 - new_cfa;
	fs->regs.reg[7].how = REG_SAVED_OFFSET;
	fs->regs.reg[7].loc.offset = (long) &sc->sc_regs.r07 - new_cfa;
	fs->regs.reg[8].how = REG_SAVED_OFFSET;
	fs->regs.reg[8].loc.offset = (long) &sc->sc_regs.r08 - new_cfa;
	fs->regs.reg[9].how = REG_SAVED_OFFSET;
	fs->regs.reg[9].loc.offset = (long) &sc->sc_regs.r09 - new_cfa;
	...
	fs->regs.reg[39].loc.offset = (long) &sc->sc_regs.ugp - new_cfa;
